...
class TestAnalyzer:
    ...
    def test_load_watchlist(self, analyzer):
        ...
        assert len(analyzer.watchlist) == 2  # 比亚迪、中际旭创（腾讯已移除）
    ...
    def test_generate_trading_strategy(self, analyzer):
        ...
        assert result['data']['strategy'] in ['offensive', 'defensive', 'waiting', 'neutral']
    ...
    def test_classify_news(self, analyzer):
        ...
        assert '🔴' in high_news.get('level_icon', '') or high_news.get('level', '') == 'high'
