...
class TestRenderer:
    ...
    def test_render_morning_report_structure(self, renderer, sample_analysis_result):
        ...
        assert '📊 30秒速览' in markdown
        assert '自选股预测' in markdown
    ...
    def test_render_evening_report_structure(self, renderer):
        ...
        assert '自选股深度分析' in markdown or '自选股复盘' in markdown
        assert '今日复盘' in markdown
        assert '明日展望' in markdown or '明日重点观察' in markdown
